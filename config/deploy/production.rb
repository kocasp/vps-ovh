...
server "51.254.143.140", :web, :app, :db, primary: true

# set RAILS_ENV
set :rails_env, :production

# the name of your application
set :application_name, "vps-ovh"

# the domain you'll be deploying your application to
set :application_domain, "vps224384.ovh.net"
...
# retrieved from from
set :scm, "git"
set :repository, "git@github.com:kocasp/vps-ovh.git"
set :branch, "master"
